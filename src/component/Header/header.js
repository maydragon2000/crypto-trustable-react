            ...
            <div id="header" className="header">
                <Navbar style={{ backgroundColor: isAuth ? "#121318" : "black" }} expand="lg" >
                    ...
                    <div className="button-wrap">
                        ...
                        <Link to="/profile" style={{ display: !isAuth ? "none" : "flex" }} className="user-picture"><img alt="" src={user === undefined || user === null ? "" : user.image === undefined ? "/image/user.jpg" : `http://127.0.0.1:5000/images/${user.image}`} /></Link>
